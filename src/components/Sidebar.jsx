...
import { IoIosArrowDown, IoIosArrowUp, IoMdMenu, IoMdClose, IoMdLogOut } from "react-icons/io";
...
function Sidebar() {
  ...
  return (
    <div className="flex h-screen relative">
      ...
      <div className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-gray-900 text-white flex flex-col transform transition-transform duration-300 ease-in-out lg:transform-none ${mobileSidebar ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
        }`}>
